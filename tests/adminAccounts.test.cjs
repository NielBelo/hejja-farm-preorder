...
const { filterAccounts, accountName } = data.exports;
const accounts = [
    { id: '1', first_name: 'Ágnes', last_name: 'Héjja', email: 'agnes@example.hu', phone: '+36301234567', county: 'Csongrád-Csanád', city: 'Szeged', status: 'registered', role: 'admin' },
    { id: '2', first_name: 'Béla', last_name: 'Kiss', email: 'bela@example.hu', county: 'Pest', status: 'unconfirmed', role: 'user' },
    { id: '3', email: 'meghivott@example.hu', county: null, status: 'invited', role: 'user' },
];
