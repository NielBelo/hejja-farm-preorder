...
export type SeasonInput = { id?: string; year: number; type: "Tavasz" | "Ősz"; price: number; weightMin: number; weightMax: number; orderStart: string; orderEnd: string; pickupDays: PickupDay[]; active: boolean };
